...
class ads125_widget extends WP_Widget {
	function ads125_widget() {
		$widget_ops = array( 'classname' => 'e3lan125-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan125<?php echo $one_column ?>">
		<?php for($i=1 ; $i<11 ; $i++ ){ ?>
...
class ads120_90_widget extends WP_Widget {
	function ads120_90_widget() {
		$widget_ops = array( 'classname' => 'e3lan120_90-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan120-90<?php echo $one_column ?>">
		<?php for($i=1 ; $i<11 ; $i++ ){ ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads120_60_widget extends WP_Widget {
	function ads120_60_widget() {
		$widget_ops = array( 'classname' => 'e3lan120_60-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan120-60<?php echo $one_column ?>">
		<?php for($i=1 ; $i<11 ; $i++ ){ ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads120_600_widget extends WP_Widget {
	function ads120_600_widget() {
		$widget_ops = array( 'classname' => 'e3lan120_600-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan120-600<?php echo $one_column ?>">
		<?php for($i=1 ; $i<3 ; $i++ ){ ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads120_240_widget extends WP_Widget {
	function ads120_240_widget() {
		$widget_ops = array( 'classname' => 'e3lan120_240-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan120-240<?php echo $one_column ?>">
		<?php for($i=1 ; $i<5 ; $i++ ){ ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads160_600_widget extends WP_Widget {
	function ads160_600_widget() {
		$widget_ops = array( 'classname' => 'e3lan160_600-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan160-600">
		<?php $i=1 ; ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads300_600_widget extends WP_Widget {
	function ads300_600_widget() {
		$widget_ops = array( 'classname' => 'e3lan300_600-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan300-600">
		<?php $i=1 ; ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads250_250_widget extends WP_Widget {
	function ads250_250_widget() {
		$widget_ops = array( 'classname' => 'e3lan250_250-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan250-250">
		<?php $i=1 ; ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads300_100_widget extends WP_Widget {
	function ads300_100_widget() {
		$widget_ops = array( 'classname' => 'e3lan300_100-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan300-100">
		<?php for($i=1 ; $i<5 ; $i++ ){ ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
...
class ads300_250_widget extends WP_Widget {
	function ads300_250_widget() {
		$widget_ops = array( 'classname' => 'e3lan300_250-widget', 'description' => ''  );
	...
	function widget( $args, $instance ) {
		...
		<div <?php if( $tran_bg ) echo 'id="'.$args['widget_id'].'"'; ?> class="e3lan300-250">
		<?php $i=1 ; ?>
			<?php if( !empty($instance[ 'ads'.$i.'_code' ])  ){ ?>
			<div class="e3lan-cell">
				<?php echo do_shortcode( $instance[ 'ads'.$i.'_code' ] ); ?>
